...
urlpatterns = [
    ...
    path('v1/auth/subscription/status/', views.UserSubscriptionStatusView.as_view(), name='v1-user-auth-subscription-status'),
    path('v1/billing/google/verify/', views.GoogleBillingVerifyView.as_view(), name='v1-billing-google-verify'),
